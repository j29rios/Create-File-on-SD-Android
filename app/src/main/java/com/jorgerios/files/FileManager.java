...
/**
 * Created by jorgerios on 05/03/15.
 */
public class FileManager {
    ...
    public void writeFile(String text){
        ...
        try{
        OutputStreamWriter fout = new OutputStreamWriter(new FileOutputStream(ruta.getAbsolutePath() + "/" + fileName, true), "UTF-8");
    ...
    public String[] fileToArray(){
        ...
        try{
        Scanner sc = new Scanner(new File(String.valueOf(ruta) + "/" + fileName));
